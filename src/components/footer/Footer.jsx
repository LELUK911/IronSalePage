...
export const Footer = () => {
    return (
        <footer className="bg-gradient-to-b  to-gray-950 text-gray-300 py-8 md:py-12 mt-16 border-t border-gray-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm md:text-base text-gray-400">
                            ...
                            Join us in revolutionizing the bond market with blockchain technology.
                        </p>
